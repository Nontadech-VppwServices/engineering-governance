...
Phase 0 establishes the governance foundation only.
...
No AI agent, database, vector database, or context service is required at this phase.
...
Phase 0  Governance foundation
   ↓
Phase 1  Project registry + ADR/BDR standards
   ↓
