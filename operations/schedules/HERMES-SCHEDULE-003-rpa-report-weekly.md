---
id: HERMES-SCHEDULE-003
title: RPA weekly report
status: draft
owner: engineering
...
Deliver the RPA weekly run summary to the LINE reporting channel. Hermes renders
the report; the deterministic outbox delivers it.

# Schedule

- Expression or interval: `5 9 * * 1`
...
- Idempotency-key strategy: `report:weekly:<from>` — the outbox deduplicates on
...
- Scope limits: period is the 7 days ending 09:00 Monday. Read-only against reporting data; cannot
